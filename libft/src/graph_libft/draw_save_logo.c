...
/*   Updated: 2018/10/16 16:04:01 by Awklm            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_save_logo(t_graph *e, int posx, int posy, int color)
{
	...
	ft_segment(e);
	draw_save_logo_init_values(e, 5, posx + (5 * e->lt.coeff), posy - (2 * e->lt.coeff));
	full_box(e);
	draw_save_logo_init_values(e, 5, posx + (5 * e->lt.coeff), posy - (9 * e->lt.coeff));
	full_box(e);
	draw_save_logo_init_values(e, 5, posx + (5 * e->lt.coeff), posy - (16 * e->lt.coeff));
	full_box(e);
